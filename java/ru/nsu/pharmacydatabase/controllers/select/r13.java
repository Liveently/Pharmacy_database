...
public class r13 implements SelectController, Initializable {
    @FXML
    ...
    private void listButtonTapped() {
        if (choiceBox.getSelectionModel().isEmpty()) {
            ...
            String sql = "SELECT med.title, mt.TYPE_NAME, pt.METHOD_OF_PREPARATION, s.price, s.ACTUAL_BALANCE as count, s.storage_id " +
                    "FROM medicament med " +
                    ...
                    "LEFT JOIN preparation_technology pt ON pt.MEDIC_ID = med.medicament_id";
            showResult(sql);
        } else {
            String sql = "SELECT med.title, mt.TYPE_NAME, pt.METHOD_OF_PREPARATION, s.price, s.ACTUAL_BALANCE as count, s.storage_id " +
                    "FROM medicament med " +
